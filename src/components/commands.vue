...
export default {
    data: () => ({
        commands: [
            ...
            {
                "command": "!newplayer",
                "description": "A link to ArenaNet's official Guild Wars 2 New Player's Guide, and a motivational speech that we're here to help",
            },
            {
                "command": "!oodie",
            ...
            {
                "command": "!rank",
                "description": "My current Guild Wars 2 PvP- and WvW rank",
            },
            {
                "command": "!server",
